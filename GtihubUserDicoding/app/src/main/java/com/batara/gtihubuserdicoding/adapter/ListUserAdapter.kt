...
class ListUserAdapter(private val listUser : ArrayList<UsersResponseItem>) : RecyclerView.Adapter<ListUserAdapter.ViewHolder>() {
    private lateinit var onItemClickCallback: OnItemClickCallback

    interface OnItemClickCallback {
        fun onItemClickClicked(data: UsersResponseItem)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickCallback.onItemClickClicked(listUser[holder.adapterPosition])
        }
    }
